...
내보낸다 — 지금은 구독하는 소비자가 없지만(tlc_type3_serving_daily는
여전히 독립적인 cron 스케줄이라 매핑 존재 여부는
check_type3_reference_ready short-circuit으로 직접 확인한다), 다른
publish 단계들과의 일관성을 위해 남겨둔다.
"""
